      ...
      <div className="w-full py-12 px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-8 xl:col-span-1">
            <div>
              ...
              <p className="mt-4 text-slate-400 text-sm max-w-md">
                Advancing scientific discovery in neurotech and healthcare through 
                real-time research curation, community engagement, and expert insights.
              </p>
            </div>
                ...
                <ul className="mt-4 space-y-4">
                  {navigation.product.map((item) => (
                    <li key={item.name}>
                      <Link 
                        href={item.href}
                        className="text-base text-slate-400 hover:text-slate-100 transition-colors"
                      >
                        {item.name}
                      </Link>
                    </li>
        ...
        <div className="mt-12 border-t border-slate-700 pt-8">
          <p className="text-base text-slate-400 text-center">
            &copy; 2024 Neuronova. All rights reserved. Built for advancing scientific discovery.
          </p>
        </div>
      </div>
    </footer>
