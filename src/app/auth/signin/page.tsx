  ...
  useEffect(() => {
    if (errorParam) {
      const errorMessages: { [key: string]: string } = {
        ...
        'OAuthCreateAccountError': 'Could not create OAuth account',
        'EmailCreateAccountError': 'Could not create account with email',
        'CallbackError': 'Authentication callback error',
